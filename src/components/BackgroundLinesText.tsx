...
export function BackgroundLinesText() {
    return (
        <BackgroundLines className="flex items-center justify-center w-full flex-col px-4">
            ...
            <p className="max-w-xl mx-auto text-sm md:text-lg text-neutral-700 dark:text-neutral-400 text-center">
                A high-performance client-side medical architecture utilizing
                automated AI structural extraction and custom cross-portal data
                states.
            </p>
        </BackgroundLines>
    );
